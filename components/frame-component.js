...
const FrameComponent = memo(({ className = "", logo, search, sVG }) => {
  return (
    <header
    ...
    >
      ...
      <div className="flex-1 bg-whitesmoke-100 border-gray-800 border-b-[1px] border-solid box-border overflow-hidden flex flex-row items-start justify-start pt-[18px] px-20 pb-4 max-w-full z-[1] text-sm text-black mq750:pl-10 mq750:pr-10 mq750:box-border">
        <div className="flex flex-row items-start justify-start gap-[70.7px] max-w-full mq480:gap-[18px] mq750:gap-[35px]">
